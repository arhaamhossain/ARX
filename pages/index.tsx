...
const categories: ProjectCategory[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        skillsHighlights: "Skill Highlights:\nCadence Virtuoso, Synopsys HSPICE...",
        highlights: [],
        images: [
      ...
      },
      {
        ...
        subProjects: [
          ...
          },
          {
            ...
            description: "An annual internal competition designed to introduce students to robotics engineering by building mechanical, electrical, and software skills. As Vice President, I directed the event, created the theme, defined the game rules, and helped participating teams design their robots.",
            images: [
          ...
          },
          {
            ...
            images: [
              "/ARX/dexter.png",
              "https://via.placeholder.com/600x400?text=RCR+Image+2",
              "/ARX/bms_circuit.svg",
            ],
          },
        ],
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen text-white relative">
      ...
      <div style={{ width: '100%', height: '100%', position: 'fixed', top: 0, left: 0, zIndex: -1, pointerEvents: 'none' }}>
        <Particles
                  ...
                  <div className="grid md:grid-cols-3 gap-12 items-start">
                    ...
                    <div className="order-2 md:order-1 space-y-6 md:col-span-1">
                      <div className="border border-gray-700 rounded-lg p-6 bg-[#131313] relative">
                        ...
                        {project.skillsHighlights && (
                          <p className="text-gray-400 text-xs leading-relaxed mt-4 whitespace-pre-line">
                            {project.skillsHighlights}
                          </p>
                        )}
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-4 text-gray-400 text-sm leading-relaxed">
            <p>
              I&apos;m an Electrical Engineering student passionate about building innovative analog and digital hardware systems. I&apos;ve worked on a range of projects that have helped me develop an intuition for hardware across multiple abstraction levels, from system architecture down to transistor-level design. My work spans across mixed-signal electronics, PCB development, and IC design.
            </p>
            <p>
              Outside of coursework, I&apos;ve dedicated much of my time to robotics. I previously served as Power Lead, Sensor Lead, and Vice President of the Stony Brook Robotics Team, where I&apos;ve contributed to the development of an autonomous search-and-rescue robot and an underwater ROV for international competition. I&apos;m also a member of the Soft Flyers Group, where my current research focuses on developing a reactive collision UAV.
            </p>
            <p>
